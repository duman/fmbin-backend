...
$(document).ready(function(){
  ...
  $.ajax({
    ...
    success : function(data){
      ...
      $('#chart-container').before('<div id="card-info"><p class="m1-txt1 p-b-36" style="padding-top: 5em; text-align: center;"><b>' + cname[0] + '</b><br><b>Position:</b> ' + pos[0] + ' - <b>Overall:</b> ' + ovr[0] + '<br><br><b>Highest Price:</b> ' + max_value[0].toLocaleString() + '<br><b>Average Price:</b> ' + avg_value[0].toLocaleString() + '<br><b>Lowest Price:</b> ' + min_value[0].toLocaleString() + '</p></div>');
    },
    error : function(data) {
    }
  });
