...
$sql = "SELECT cname, Nposition as pos, Novr as ovr, MAX(price_value) as max_value, AVG(price_value) as avg_value, MIN(price_value) as min_value FROM players, Ncard";
if(!empty($player_id)) {
